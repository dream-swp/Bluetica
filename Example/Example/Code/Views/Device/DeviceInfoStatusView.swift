...
struct DeviceInfoStatusView: View {
...
extension DeviceInfoStatusView {

    private func icon(_ handler: () -> (Device)) -> some View {
        VStack {
            let device = handler()
    ...
    private func info(_ handler: () -> (Device)) -> some View {
    ...
    private func status(_ handler: () -> (Device)) -> some View {
        HStack {
            let device = handler()
            Text("信号强度:")
                .font(.caption)
...
extension DeviceInfoStatusView {
    ...
    private func primaryServices(_ handler: () -> (Device)) -> [GridData] {
    ...
    private func advertisement(_ handler: () -> (Device)) -> [GridData] {
